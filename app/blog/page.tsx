  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-14 sm:px-8">
      <section className="page-intro border-b border-white/10 pb-10">
        ...
        <h1 className="mt-4 text-5xl font-semibold text-[var(--foreground)]">{zh ? '思考，持续发生。' : 'Thinking, in the open.'}</h1>
        <p className="mt-5 max-w-3xl text-lg leading-8 text-[var(--body-text)]">
          {zh ? '关于数学、优化、学习系统与研究的笔记。' : 'Notes on mathematics, optimization, learning systems, and research.'}
        </p>
      </section>
