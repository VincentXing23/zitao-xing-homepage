...
% ==================== Experience ====================
\section{Research, Projects \& Experience}
...
\begin{itemize}
  ...
  \item Studied GPU parallel computing and CUDA fundamentals, including thread organization, memory management, and parallel acceleration for scientific computing.
  \item Used Python and deep-learning frameworks to examine how learning rate, training epochs, and network architecture affect model convergence and generalization.
\end{itemize}
...
\skillItem{Research Interests}{Applied mathematics, machine learning, retrieval-augmented generation, operations research, graph algorithms}
